The Fictional Workflow Builder has a few global dependencies:  NodeJS and TypeScript.  Both must be installed on the development machine before running the code.
